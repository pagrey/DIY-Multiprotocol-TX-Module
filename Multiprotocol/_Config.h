...
//Several protocols use an RX ID stored in eeprom memory. If the MULTI_CONFIG protocol is enabled This replaces the erase
// eeprom option in the protocol with RX ID settings. Currently supported protocols are: PROTO_AFHDS2A = 28,
// PROTO_BUGS = 41, PROTO_BUGSMINI, PROTO_TRAXXAS, PROTO_HOTT = 57, PROTO_MOULDKG = 90.
//Default is commented, you should uncoment only for test purpose or if you know exactly what you are doing!!!
//#define MULTI_RXID
