...
// erase eeprom option in the MultiConfig.lua script with RX ID settings. Currently supported protocols are: FlSky2A, Bugs,
// BugsMini, Kyosho(Traxxas), Hott, MouldKg, XK2 and JIABAILE.
//Default is commented, you should uncoment only for test purpose or if you know exactly what you are doing!!!
//#define MULTI_RXID
